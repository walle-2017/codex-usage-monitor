...
Write-Host 'PASS: source contains no removed providers, legacy updater framework, WinGet packaging, widget visibility toggle, or historical iteration artifacts.'
