...
Assert-Match $updater 'https://github\.com/walle-2017/codex-usage-monitor/releases/latest' 'Latest discovery must use the fork github.com redirect endpoint.'
Assert-NoMatch $updater 'https://api\.github\.com/repos/walle-2017/codex-usage-monitor/releases/latest' 'Normal discovery must not use the rate-limited REST latest-release API.'
